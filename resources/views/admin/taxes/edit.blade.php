            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Tax
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.tax.update',$tax->id) }}" id="tax_form"
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                placeholder="Tax Name..." value="{{ old('name') ? old('name') : $tax->name }}">
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="amount"
                                                ...
                                                placeholder="Tax Amount..." value="{{ old('amount') ? old('amount') : $tax->amount }}" min="1" onkeypress="validate()">
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" name="status" class="custom-control-input" value="1" id="customSwitch1" {{ $tax->status || old('status') ? 'checked' : '' }}>
