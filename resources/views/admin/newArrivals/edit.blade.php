...
@section('content')
@php
    $productArr = array_filter(explode(',',$newArrival->product_id));
    // dd($productArr);
@endphp
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        ...
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                ...
                <h2 class="content-header-title float-left mb-0">Edit New Arrivals</h2>
                ...
                <div class="breadcrumb-wrapper col-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            ...
                            <a href="{{ route('admin.newArrivals.index') }}">Manage  New Arrivals</a>

                        </li>

                        <li class="breadcrumb-item active">Edit New Arrivals
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Edit  New Arrivals</h4>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.newArrivals.update',$newArrival->id) }}" id="banner_form" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        @if($newArrival->image!='')
                                        <img src="{{ asset('uploads/banners/'.$newArrival->image) }}"
