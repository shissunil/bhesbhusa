    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        ...
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                ...
                <h2 class="content-header-title float-left mb-0">Add New Arrivals</h2>
                ...
                <div class="breadcrumb-wrapper col-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add New arrivals
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Add  New Arrivals</h4>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.newArrivals.store') }}" id="banner_form"
