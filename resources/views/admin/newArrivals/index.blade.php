...
<div class="content-header row">
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Manage New Arrivals</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.dashboard') }}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">Manage New Arrivals
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> New Arrivals List</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            @if(count($newArrival) < 16)
                                @if(Auth()->user()->permissions->contains('name','admin.newArrivals.create'))
                                    <a href="{{ route('admin.newArrivals.create') }}" class="btn btn-primary float-right"><i
                                        class="fa fa-plus"></i> Add  New Arrivals</a>
                                @endif
                            @endif
                                ...
                                <table class="table table-striped zero-configuration">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Status</th>
                                            @if(
                                            Auth()->user()->permissions->contains('name','admin.newArrivals.edit')
                                            ||
                                            Auth()->user()->permissions->contains('name','admin.newArrivals.destroy')
                                            )
                                            <th>Action</th>
                                            @endif
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($newArrival as $arrivals)
                                        <tr>

                                            <td>{{ $loop->iteration}}</td>

                                            <td>
                                                <img src="{{ asset('uploads/banners/'.$arrivals->image) }}"
                                            ...
                                            <td>
                                                @if(Auth()->user()->permissions->contains('name','admin.newArrivals.edit'))
                                                <a href="{{ route('admin.newArrivals.edit',$arrivals->id) }}"
