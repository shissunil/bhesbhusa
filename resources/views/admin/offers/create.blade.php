                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.offers.store') }}" id="offer_form"
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="offer_name"
                                                ...
                                                placeholder="Offer Name..." value="{{ old('offer_name') }}">
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="offer_code"
                                                ...
                                                placeholder="Offer Code..." value="{{ old('offer_code') }}">
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1 hidden" id="total_amount">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="total_amount"
                                                ...
                                                placeholder="EX : purchase 10000 NR then 10% off" value="{{ old('total_amount') }}" min="1" onkeypress="validate()">
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="offer_discount"
                                                ...
                                                placeholder="ex: 10%" value="{{ old('offer_discount') }}" min="1" max="100" onkeypress="validate()">
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="total_use"
                                                ...
                                                placeholder="ex: 10" value="{{ old('total_use') }}" min="1" onkeypress="validate()" required>
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-12 col-md-12 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <textarea name="offer_description"
                                                ...
                                                placeholder="Offer Description...">{{ old('offer_description') }}</textarea>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" name="offer_status" class="custom-control-input" value="1" id="customSwitch1" {{ old('offer_status') ? 'checked' : '' }}>
