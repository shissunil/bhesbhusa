...
Delivery Associates Management
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        ...
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                ...
                <h2 class="content-header-title float-left mb-0">Delivery Associates</h2>
                ...
                <div class="breadcrumb-wrapper col-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Delivery Associates
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Delivery Associates List</h4>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                             ...
                             @if(Auth()->user()->permissions->contains('name','admin.delivery_associates.create'))
                            <a href="{{ route('admin.delivery_associates.create') }}" class="btn btn-primary float-right"><i
                                    class="fa fa-plus"></i> Add Delivery Associates</a><br><br>
                            @endif
                            ...
                            <div id="deliveryAssociatesTable">
                                    ...
                                    <table class="table table-striped dataex-html5-selectors_1">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                @if(Auth()->user()->permissions->contains('name','admin.delivery_associates.edit'))
                                        ...
                                        <tbody>
                                            ...
                                            @if(count($delivery_associates) > 0)

                                            @foreach ($delivery_associates as $user)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($user->hasManyOrder)
                                                        {{ $user->hasManyOrder->sum('total_amount') }}
                                                    @endif
                                                </td>
                                                <td>{{ $user->email }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.delivery_associates.edit',$user->id) }}"
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#filterStatus").change(function(){
            ...
            // console.log(status);
            $.ajax({
                url: "{{ route('admin.delivery_associates.index') }}",
                type: 'GET',
                data: {
                    status: status,
                    _token: "{{ csrf_token() }}"
                ...
                success: function(data) {
                    // console.log(data);
                    $("#deliveryAssociatesTable").html(data);
                }
            });
        });
    });
