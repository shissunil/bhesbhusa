...
<div class="content-header row">
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Manage Advertisement</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.dashboard') }}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">Manage Advertisement
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            @if(count($banners) < 5 )
                                @if(Auth()->user()->permissions->contains('name','admin.banners.create'))
                                <a href="{{ route('admin.banners.create') }}" class="btn btn-primary float-right"><i
                                ...
                                <table class="table table-striped zero-configuration">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Status</th>
                                            @if(
                                            Auth()->user()->permissions->contains('name','admin.banners.edit')
                                            ||
                                            Auth()->user()->permissions->contains('name','admin.banners.destroy')
                                            )
                                            <th>Action</th>
                                            @endif
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(Auth()->user()->permissions->contains('name','admin.banners.edit'))
