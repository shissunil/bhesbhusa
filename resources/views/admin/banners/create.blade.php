                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <label for="basicInputFile" class="mb-1">Banner Image <span class="text-danger h6">*</span></label>
                                    ...
                                    {{-- <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <label for="name" class="mb-1">Banner Location <span class="text-danger h6">*</span></label>
...
<script>
    ...
    $(document).ready(function(){
        ...
        //         return false;
        //     }
        // },'Please upload an image with 1920 x 768 pixels dimension');
