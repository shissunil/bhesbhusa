...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add City</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add City
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.city.store') }}" id="city_form"
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="number" name="delivery_days"
                                                ...
                                                id="delivery_days" placeholder="Estimate Delivery Day..."
                                                value="{{ old('delivery_days') }}">
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1" id="shipping_charge_div">
                                        <fieldset class="form-group">
                                            <label for="shipping_charge" class="mb-1">Shipping Charge </label>
                                            <input type="number" name="shipping_charge" class="form-control @error('shipping_charge') is-invalid @enderror" id="shipping_charge" placeholder="Shipping Charge..."
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" name="is_free" class="custom-control-input" value="1" id="free_shipping" {{ old('is_free') ? 'checked' : '' }}>
