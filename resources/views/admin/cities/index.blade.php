    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        ...
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                ...
                <h2 class="content-header-title float-left mb-0">City Master</h2>
                ...
                <div class="breadcrumb-wrapper col-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">City Master
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            @if(Auth()->user()->permissions->contains('name','admin.city.create'))

                            <a href="{{ route('admin.city.create') }}" class="btn btn-primary float-right"><i
                                ...
                                <table class="table table-striped zero-configuration">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th>Estimate Delivery Day</th>

                                            <th>Status</th>

                                            @if(

                                            Auth()->user()->permissions->contains('name','admin.city.edit')

                                            ||

                                            Auth()->user()->permissions->contains('name','admin.city.destroy')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{!! $city->status ? '<p class="badge badge-pill badge-light-primary">
                                            ...
                                            <td>
                                                ...
                                                @if(Auth()->user()->permissions->contains('name','admin.city.edit'))
