            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.cms-master.index') }}">CMS Management</a>
                        </li>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.web-cms-master.store') }}" id="city_form"
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="file" name="image_one" id="image_one" class="dropify">
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            <label for="name" class="mb-1">Cms Image Two</label>
                                            <input type="file" name="image_two" id="image_two" class="dropify">
                                        </fieldset>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="file" name="image_three" id="image_three" class="dropify">
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="title_one"
                                                class="form-control @error('title_one') is-invalid @enderror" id="title_one"
                                                placeholder="Title..." value="{{ old('title_one') }}">
                                        </fieldset>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="title_two"
                                                ...
                                                placeholder="Title..." value="{{ old('title_two') }}">
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="title_three"
                                                ...
                                                placeholder="Title..." value="{{ old('title_three') }}">
                                        </fieldset>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 col-12">
                                        <fieldset class="form-group">
                                            ...
                                            <textarea name="discription_one" id="discription_one"></textarea>
                                        </fieldset>
                                    </div>
                                    <div class="col-sm-12 col-12">
                                        <fieldset class="form-group">
                                            <label for="roundText" class="mb-1">Description Two</label>
                                            <textarea name="discription_two" id="discription_two"></textarea>
                                        </fieldset>
                                    </div>
                                    <div class="col-sm-12 col-12">
                                        <fieldset class="form-group">
                                            <label for="roundText" class="mb-1">Description Three</label>
                                            <textarea name="discription_three" id="discription_three"></textarea>
                                        </fieldset>
                                    </div>
                                </div>
                                <button type="submit"
