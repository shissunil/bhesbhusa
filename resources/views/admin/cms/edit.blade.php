            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.cms-master.update',$cmsData->id) }}" id="city_form"
                                    ...
                                    <!-- <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="select2 form-control select2-hidden-accessible" name="cms_page">
                                                ...
                                                <option value="4" {{ ($cmsData->cms_page == '4') ? 'selected' : '' }}>Return Policy</option>
                                                <option value="5" {{ ($cmsData->cms_page == '5') ? 'selected' : '' }}>Help Center</option>
                                            </select>
                                        </fieldset>
                                    </div> -->
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="title"
                                                ...
                                                placeholder="Title..." value="{{ $cmsData->title}}">
                                        </fieldset>
                                    </div>
                                </div>
                                <!-- <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            <label for="name" class="mb-1">App Type</label>
                                            <select class="select2 form-control select2-hidden-accessible"
                                                name="app_type">
                                                <option value="1" {{ $cmsData->status == '1' ? 'selected' : '' }}>Customer</option>
                                                <option value="2" {{ $cmsData->status == '2' ? 'selected' : '' }}>Deliver</option>
                                            </select>
                                        </fieldset>
                                    </div>
                                </div> -->
                                 <div class="row">
                                    <div class="col-sm-12 col-12">
                                        <fieldset class="form-group">
                                            <label for="roundText" class="mb-1">Description</label>
