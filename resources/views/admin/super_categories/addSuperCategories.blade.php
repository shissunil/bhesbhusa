            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('saveSuperCategoryList') }}" id="category_form"
                            ...
                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="supercategory_image" class="dropify" id="supercategory_image">
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="supercategory_name"name="supercategory_name" placeholder="Super Category Name...">
                                    </fieldset>
                                </div>
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        <label for="status">SuperCategory Status</label>
                                        <select class="form-control" id="supercategory_status" name="supercategory_status">
