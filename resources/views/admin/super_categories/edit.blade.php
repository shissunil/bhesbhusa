            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Super Category
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.super-category.update',$superCategory->id) }}"
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="supercategory_image" class="dropify"
                                                    ...
                                                    data-default-file="{{ URL::asset('uploads/super_category/'.$superCategory->supercategory_image) }}"
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="supercategory_name" class="form-control"
                                                id="supercategory_name" placeholder="Category Name..."
                                                value="{{ $superCategory->supercategory_name }}">
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            <label class="mb-1 d-block">Super Category Status</label>
                                            <select class="form-control" id="status" name="supercategory_status">
                                                <option value="1" {{ ($superCategory->supercategory_status == '1') ?
                                                    'selected' : '' }}>Active</option>
                                                <option value="0" {{ ($superCategory->supercategory_status == '0') ?
