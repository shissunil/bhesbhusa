            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <a href="{{ route('addProduct') }}" class="btn btn-primary float-right"><i class="fa fa-plus"></i> Add</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('editProduct',$product->id) }}" class="btn btn-primary btn-sm" title="Edit"><i class="fa fa-pencil fa-lg"></i>
                                                </a>
                                                <a href="{{ route('deleteProduct',$product->id) }}" class="btn btn-danger btn-sm" title="Delete"><i class="fa fa-trash fa-lg"></i></a>
                                            </td>
                                        </tr>
