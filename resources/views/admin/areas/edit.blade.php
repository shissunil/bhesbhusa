...
<div class="content-header row">
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Edit Area</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Area
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.area.update',$area->id) }}" id="area_form"
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="select2 form-control select2-hidden-accessible"
                                                ...
                                                <option value="{{ $state->id }}" {{ $area->state_id==$state->id ?
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="select2 form-control select2-hidden-accessible"
                                                ...
                                                <option value="{{ $city->id }}" {{ $area->city_id==$city->id ?
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="select2 form-control select2-hidden-accessible"
                                                ...
                                                <option value="{{ $pincode->id }}" {{ $area->pincode_id==$pincode->id ?
                                                    'selected' : '' }} >{{ $pincode->pincode }}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </fieldset>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="area"
                                                ...
                                                placeholder="Area..." value="{{ old('area') ? old('area') : $area->area }}">
                                        </fieldset>
                                    </div>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" name="status" class="custom-control-input"
                                                    value="1" id="customSwitch1" {{ (old('status') ||  $area->status ) ? 'checked' : '' }}>
