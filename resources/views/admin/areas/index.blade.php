...
<div class="content-header row">
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Area Master</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.dashboard') }}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">Area Master
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @if(Auth()->user()->permissions->contains('name','admin.area.create'))

                            <a href="{{ route('admin.area.create') }}" class="btn btn-primary float-right">
                                ...
                                <table class="table table-striped zero-configuration">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Status</th>
                                            @if(
                                            Auth()->user()->permissions->contains('name','admin.area.edit')
                                            ||
                                            Auth()->user()->permissions->contains('name','admin.area.destroy')
                                            )
                                            <th>Action</th>
                                            @endif
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {!! $area->status ? '<p class="badge badge-pill badge-light-primary">
                                            ...
                                            <td>
                                                @if(Auth()->user()->permissions->contains('name','admin.area.edit'))
