    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        ...
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                ...
                <h2 class="content-header-title float-left mb-0">Add Color</h2>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.color.store') }}" id="color_form"
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" name="color"
                                                ...
                                                placeholder="Color Name..." value="{{ old('color') }}">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <div class="input-group colorpicker-element">
                                                ...
                                                <input name="code" class="form-control input-block color-io @error('code') is-invalid @enderror" value="{{ old('code') }}" />
