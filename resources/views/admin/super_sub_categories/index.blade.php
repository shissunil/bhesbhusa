            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Super Sub Category
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            @if(Auth()->user()->permissions->contains('name','admin.super-sub-category.create'))
                            <a href="{{ route('admin.super-sub-category.create') }}"
                                ...
                                <table class="table table-striped zero-configuration">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Status</th>
                                            @if(
                                            Auth()->user()->permissions->contains('name','admin.super-sub-category.edit')
                                            ||
                                            Auth()->user()->permissions->contains('name','admin.super-sub-category.destroy')
                                            )
                                            <th>Action</th>
                                            @endif
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ URL::asset('uploads/super_sub_category/'.$superSubCategory->supersub_cat_image) }}"
                                            ...
                                            <td>
                                                @if(Auth()->user()->permissions->contains('name','admin.super-sub-category.edit'))
                                                <a href="{{ route('admin.super-sub-category.edit',$superSubCategory->id) }}"
                                                    class="btn btn-primary btn-sm" title="Edit">
                                                    <i class="fa fa-pencil fa-lg"></i>
                                                </a>
                                                @endif
                                                @if(Auth()->user()->permissions->contains('name','admin.super-sub-category.destroy'))
                                                <button type="button" class="btn btn-sm btn-danger delete-record"
                                                    data-action="{{ route('admin.super-sub-category.destroy',$superSubCategory->id) }}">
