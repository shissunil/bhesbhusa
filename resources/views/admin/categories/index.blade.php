                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @if(Auth()->user()->permissions->contains('name','admin.category.create'))
                                ...
                                <table class="table table-striped zero-configuration">
                                    <thead>
                                        <tr>
                                            ...
                                            @if(
                                            Auth()->user()->permissions->contains('name','admin.category.edit')
                                            ||
                                            Auth()->user()->permissions->contains('name','admin.category.destroy')
                                            )
                                            <th>Action</th>
                                            @endif
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if(Auth()->user()->permissions->contains('name','admin.category.edit'))
