...
Edit Trending In Men

@endsection

@section('content')
@php
    $productArr = array_filter(explode(',',$trendingMen->product_id));
    // dd($productArr);
@endphp
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        ...
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                ...
                <h2 class="content-header-title float-left mb-0">Edit Trending In Men</h2>
                ...
                <div class="breadcrumb-wrapper col-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            ...
                            <a href="{{ route('admin.trendingInMen.index') }}">Manage Trending In Men</a>

                        </li>

                        <li class="breadcrumb-item active">Edit Trending In Men
                        </li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Edit Trending In Men</h4>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.trendingInMen.update',$trendingMen->id) }}" id="banner_form" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
