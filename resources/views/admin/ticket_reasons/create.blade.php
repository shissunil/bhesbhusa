...
<div class="content-header row">
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Ticket Reason</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Ticket Reason
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Ticket Reason</h4>
                    </div>
                    <div class="card-content">

                        <div class="card-body">

                            <form method="post" action="{{ route('admin.ticket-reasons.store') }}" id="category_form"
                                    ...
                                    <div class="col-xl-12 col-md-12 col-12 mb-1">
                                        <fieldset class="form-group">
                                            ...
                                            <textarea name="reason_description"
                                                ...
                                                placeholder="Ticket Reason...">{{ old('reason_description') }}</textarea>
                                        </fieldset>
                                    </div>
