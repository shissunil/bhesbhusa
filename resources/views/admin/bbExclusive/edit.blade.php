...
@section('content')
@php
    $productArr = array_filter(explode(',',$exclusiveProduct->product_id));
    // dd($productArr);
@endphp
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        ...
        <div class="row breadcrumbs-top">
            ...
            <div class="col-12">
                ...
                <h2 class="content-header-title float-left mb-0">Edit BBExclusive</h2>
                ...
                <div class="breadcrumb-wrapper col-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            ...
                            <a href="{{ route('admin.bestdeals.index') }}">Manage BBExclusive</a>

                        </li>

                        <li class="breadcrumb-item active">Edit BBExclusive
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 class="card-title">Edit BBExclusive</h4>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.exclusive.update',$exclusiveProduct->id) }}" id="banner_form" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        @if($exclusiveProduct->image!='')
                                        <img src="{{ asset('uploads/banners/'.$exclusiveProduct->image) }}"
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <fieldset class="form-group">
                                            <label for="name" class="mb-1">Select Product <span class="text-danger h6">*</span></label>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" name="status" class="custom-control-input"
                                                    ...
                                                    $exclusiveProduct->status ? 'checked' : '' }}>
