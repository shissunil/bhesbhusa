    ...
    <section class="inner-page-banner">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Search results for : {{ $_GET['keyword'] ?? '' }}</li>


            </ol>

            <div class="page-title">
                <h1>{{ $_GET['keyword'] ?? '' }}</h1><span> {{ $productList->total() }} items</span>
            </div>
            ...
            <div class="shop-listing">
                ...
                <div class="shop-product-list-view">
                    ...
                    <div class="listof-product" id="product_list">
                        ...
                        <div>
                            @if (count($productList) > 0)
                                {{ $productList->withQueryString()->links('vendor.pagination.default') }}
                            @endif
                        </div>
