...
class OrderController extends Controller
{
    ...
    public function orderDetail(Request $request,$id)
    {
        ...
        return view('front.orderDetails',compact('data'));
    }
    ...
    public function returnOrderConfirm(Request $request)
    {
        ...
        if ($orderData)
        {
            $addressId = $orderData->user_address_id;
            ...
            return redirect()->route('orderDetail',$orderId)->with('success','order returned');
        }
        else
        {
